...
router.post('/authenticate', (req, res) => {
	...
	//test in postman
	var {username,password} = req.body;//we get username and pwd
	var credential = {username,password}//we find in loop
	User.findOne(credential)//we find one matching
	.then((user) => {
	    return res.json(user);//if get correct user
	});
});
